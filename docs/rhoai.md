...
3) Access the `workbench` named `chatbot-d1742473203600-notebook`.
...
5) In the terminal, run `cd chatbot-d1742473203600` to navigate to your sample app's directory.
